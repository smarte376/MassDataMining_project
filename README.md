...
2. write accuracy check codes for measuring the classification accuracy against 3 baseline classification methods: k-nearest-neighbor (kNN) on raw pixels, Eigenface [7], and the 2 PRNU-based fingerprint method from Marra et al. [8]. (this might already be given in fingerprintGAN source code, need to verify)
