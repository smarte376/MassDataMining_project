"""
Create Test Sets for CelebA Dataset
...
"""
# # Create all test sets with all attacks (clean + 6 attacked versions)
# python create_celeba_test_sets.py

# # Create only clean test sets (no attacks)
# python create_celeba_test_sets.py --clean_only

# # Use specific attacks only
# python create_celeba_test_sets.py --attacks noise blur crop
...
def main():
    parser = argparse.ArgumentParser(description='Create CelebA Test Sets with Adversarial Attacks')
    parser.add_argument('--real_dir', type=str, default=REAL_IMAGE_DIR, 
                       help='Directory with real CelebA images')
    ...
    print("=" * 80)
    print("CREATING CELEBA TEST SETS WITH ADVERSARIAL ATTACKS")
    print("=" * 80)
